...
export const getTasksPending = createStandardAction('GET_TASKS_REQUEST')<void>();
export const getTasksSuccess = createStandardAction('GET_TASKS_SUCCESS')<Task[]>();
export const getTasksError = createStandardAction('GET_TASKS_ERROR')<string>();

export const deleteTaskPending = createStandardAction('DELETE_TASK_REQUEST')<void>();
export const deleteTaskSuccess = createStandardAction('DELETE_TASK_SUCCESS')<number>();
export const deleteTaskError = createStandardAction('DELETE_TASK_ERROR')<string>();
...
export const updateTaskPending = createStandardAction('UPDATE_TASK_REQUEST')<void>();
export const updateTaskSuccess = createStandardAction('UPDATE_TASK_SUCCESS')<Task>();
export const updateTaskError = createStandardAction('UPDATE_TASK_ERROR')<string>();
